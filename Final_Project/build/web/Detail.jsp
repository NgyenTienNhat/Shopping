<%-- 
    Document   : Detail
    Created on : Mar 3, 2022, 8:49:09 PM
                ...
                <div class="col-lg-6 text-center text-lg-right">
                    <div class="d-inline-flex align-items-center">
                         <c:if test="${sessionScope.account != null}">
                            <div  class="btn-group">
                                <a type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Xin chao,${sessionScope.account.account}</a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active" href="detail">Shop Detail</span>
                </nav>
            </div>
        </div>
    </div>
...
<!--                        <div class="carousel-item">
                            <img class="w-100 h-100" src="images/ip12.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">${detail.price} VND</h3>
